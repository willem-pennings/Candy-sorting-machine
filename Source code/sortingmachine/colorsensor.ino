...
ItemColor determineColor(int measuredColor[]) {
  ...
  if(debug){
    ...
    switch(itemcolor) {
      case mm_red: Serial.println(F("INFO\t\tDetected a red M&M piece!")); break;
      case mm_green: Serial.println(F("INFO\t\tDetected a green M&M piece!")); break;
      case mm_blue: Serial.println(F("INFO\t\tDetected a blue M&M piece!")); break;
      case mm_yellow: Serial.println(F("INFO\t\tDetected a yellow M&M piece!")); break;
      case mm_orange: Serial.println(F("INFO\t\tDetected an orange M&M piece!")); break;
      case mm_brown: Serial.println(F("INFO\t\tDetected a brown M&M piece!")); break;
  
      case sk_red: Serial.println(F("INFO\t\tDetected a red Skittles piece!")); break;
      case sk_green: Serial.println(F("INFO\t\tDetected a green Skittles piece!")); break;
      case sk_yellow: Serial.println(F("INFO\t\tDetected a yellow Skittles piece!")); break;
      case sk_orange: Serial.println(F("INFO\t\tDetected an orange Skittles piece!")); break;
      case sk_purple: Serial.println(F("INFO\t\tDetected a purple Skittles piece!")); break;
  
      case unknown: Serial.println(F("WARNING\t\tFailed to get a color! Sample has been marked as unknown.")); break;
    }
  }
  return itemcolor;
}
